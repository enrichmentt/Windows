#
# Манифест модуля для модуля "WER".
#
...
@{
    ...
    GUID              = '564e5920-9494-4128-86a5-cb05b2502c3f'
    ...
    FunctionsToExport = @('Add-CollectWerDump', 'Get-CollectWerDump', 'Remove-CollectWerDump', 'Disable-Wer', 'Get-Wer')
