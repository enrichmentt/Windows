#
# Манифест модуля для модуля "UserProfile".
#
# Создано: Pekshev Vladimir
#
# Дата создания: 14.08.2020
#
...
@{
    ...
    FunctionsToExport = @('Get-UserProfile', 'Remove-UserProfile', 'Set-DateLastLogin')
